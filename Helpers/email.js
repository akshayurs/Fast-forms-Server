...
exports.sendMail = async (to, subject, body) => {
  ...
  let info = await transporter.sendMail({
    from: '"Fast Forms" <fastformsonline@gmail.com>',
    to,
    subject,
    text: body,
    html: body,
            ...
            <tr>
              ...
              <tr>
                <td
                  ...
                  "
                >
                  <p style="margin: 0">Cheers,<br />Fast Forms Team<br><a href="${process.env.SITE_URL}">${process.env.SITE_URL}</p>
                </td>
              </tr>
            </table>
          </td>
